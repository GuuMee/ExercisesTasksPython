...
called asctime in the time module. It reads the current time from the com�puter’s internal clock and returns it in a human-readable format. Write a program
